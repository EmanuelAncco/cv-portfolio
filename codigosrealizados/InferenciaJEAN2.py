...
# Añadir un "padding" o margen para que los datos no toquen los bordes del gráfico
error_display_max = error_upper_bound * 1.1
ssim_display_min = ssim_lower_bound * 0.98

# *** Lógica de ploteo para crear bloques visuales con todos los puntos ***
current_x_offset = 0

# (a) y (b) Scatter plots
for sensor_id in unique_sensors:
    # Seleccionar todos los datos de este sensor
    ...
    # Dibujar TODOS los puntos para este sensor, pero más pequeños y transparentes para simular densidad.
