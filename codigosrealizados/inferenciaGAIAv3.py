...
- El modelo entrenado guardado en formato SavedModel ('modeloGAIA' por defecto)
"""
...
# ¡ASEGÚRATE DE QUE ESTA RUTA APUNTE A LA CARPETA 'modeloGAIA'!
MODEL_PATH = "modeloGAIA"
